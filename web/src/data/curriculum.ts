...
export const modules: Module[] = [
  {
    ...
    notebooks: [
      { name: 'modul01_01_model_serilestirme.ipynb', desc: 'scikit-learn modelinin joblib + safetensors ile saklanması ve yüklenmesi', url: 'https://colab.research.google.com/drive/14-aWFh3l_81nvp_tVw5SREtGhLuVkwPS' },
      { name: 'modul01_02_fastapi_inference.ipynb', desc: 'FastAPI + Pydantic ile production-ready inference endpoint', url: 'https://colab.research.google.com/drive/15zh_DC1XmkuHq8m-WlC62i4rI6mHaR8R' },
      { name: 'modul01_03_docker_paketleme.ipynb', desc: 'Multi-stage Dockerfile, docker build/run, image inspect ve health-check', url: 'https://colab.research.google.com/drive/1EF_n6z67BDK58wIhpW9NjWapEoVjKn3M' },
      { name: 'modul01_04_hf_inference_servisi.ipynb', desc: 'Hugging Face metin sınıflandırma modelinin uçtan uca servisleştirilmesi', url: 'https://colab.research.google.com/drive/1quiDbtQA14CE9tmjn4KhbvDMnVSaSR9E' },
    ],
    ...
    pptxDriveId: '11ZxWc66xbZlgNy2GPc2WuaG06Sedx0fh',
  },
  {
    id: 2,
    slug: '02',
    ...
    notebooks: [
      { name: 'modul02_01_tokenization_context.ipynb', desc: 'HuggingFace tokenizer ile token sayımı, context window analizi, multilingual karşılaştırma', url: 'https://colab.research.google.com/drive/1ybrwcaBYXODOkdjJyKhQefO_PG5O89F0' },
      { name: 'modul02_02_ai_studio_prompt.ipynb', desc: 'Google AI Studio ile Gemini üzerinde prompt karşılaştırma deneyleri', url: 'https://colab.research.google.com/drive/1gXQQTOaTK_nmI9xDic4IdFZ5KhwfzpF2' },
      { name: 'modul02_03_cot_react.ipynb', desc: 'Chain-of-Thought ve ReAct desenleri ile matematik/akıl yürütme problemleri', url: 'https://colab.research.google.com/drive/1bZqtexd9HV2a9DpkoOzIMk7Gw3DYCJ3V' },
      { name: 'modul02_04_function_calling.ipynb', desc: 'Function calling örneği: hava durumu, hesap makinesi, web arama tool\'ları', url: 'https://colab.research.google.com/drive/100ODfNys2zSu-L8LquyNh4xUgVWOmN4n' },
    ],
    ...
    pptxDriveId: '1e9l2rJfuWiN60REeaVH7Q8UmW3TQ-A_C',
  },
  {
    id: 3,
    slug: '03',
    ...
    notebooks: [
      { name: 'modul03_01_hf_hub_kesfi.ipynb', desc: 'Hugging Face Hub üzerinde model keşfi, model card analizi, lisans kontrolü', url: 'https://colab.research.google.com/drive/1hZuvl-LmwCxw6sISc9-jLgVv2jyXIE1r' },
      { name: 'modul03_02_transformers_pipeline.ipynb', desc: 'Pipeline ile NER, çeviri, özetleme; AutoModel ile manuel inference akışı', url: 'https://colab.research.google.com/drive/11Cz_fMtG1SPPKH9IaRLmb6wgI1vovzet' },
      { name: 'modul03_03_datasets_kutuphanesi.ipynb', desc: 'Türkçe bir veri setini yükle, map/filter ile dönüştür, streaming ile büyük veri', url: 'https://colab.research.google.com/drive/1gt56QppgPRLkh0cBSmFQM9HOOmcT-zUG' },
      { name: 'modul03_04_ollama_kurulum.ipynb', desc: 'Ollama kurulumu, model çekme, REST API ile sorgu, custom Modelfile yazımı', url: 'https://colab.research.google.com/drive/1Ej4TJ83obpjBLJEPCJao3KOzCaIlJ7cA' },
      { name: 'modul03_05_lm_studio_endpoint.ipynb', desc: 'LM Studio GUI yönetimi, OpenAI SDK ile lokal endpoint kullanımı', url: 'https://colab.research.google.com/drive/14tsPaVoy-Ugki69yD4LuyKjC_QKnqLKY' },
      { name: 'modul03_06_streamlit_chat.ipynb', desc: 'Streamlit + Ollama ile basit lokal chat arayüzü', url: 'https://colab.research.google.com/drive/1snVAjYb2xSs8_mKisNwLtnSjVwaJsiym' },
    ],
    ...
    pptxDriveId: '1JA7p9I9DXfrhpz_YhLwJl96uJzTDyj5U',
  },
  {
    id: 4,
    slug: '04',
    ...
    notebooks: [
      { name: 'modul04_01_embeddings_karsilastirma.ipynb', desc: 'Sentence-Transformers ile embedding üretimi, MTEB skor karşılaştırması', url: 'https://colab.research.google.com/drive/14N3ADu7etUn_O6qSD4_61vyX99zY2JAK' },
      { name: 'modul04_02_chromadb_kurulum.ipynb', desc: 'ChromaDB ile koleksiyon yönetimi: add, query, delete, metadata filter', url: 'https://colab.research.google.com/drive/1c7wLyZ-_Pb0KCp13QcI_7JAOSXYYLy1M' },
      { name: 'modul04_03_pdf_chunking_pipeline.ipynb', desc: 'PDF setinden chunking → embedding → vector store dolumu pipeline\'ı', url: 'https://colab.research.google.com/drive/16K2fGo4j4R9hgDM1uKv0aj8ispxYDuo5' },
      { name: 'modul04_04_langchain_lcel.ipynb', desc: 'LangChain LCEL ile retriever | prompt | LLM | parser zinciri kurma', url: 'https://colab.research.google.com/drive/1A0b0AbSDUvuSkswhlNHb_9MqjJZNfrlP' },
      { name: 'modul04_05_hybrid_retrieval_rerank.ipynb', desc: 'BM25 + dense hybrid + MMR + cross-encoder reranker entegrasyonu', url: 'https://colab.research.google.com/drive/1LPEZxgmnb7SxqLTB619Vn6y07d22mWoe' },
      { name: 'modul04_06_langgraph_agent.ipynb', desc: 'LangGraph ile query routing + reflection adımları içeren agent tabanlı RAG', url: 'https://colab.research.google.com/drive/1DLM-cDSVeJ8jTJGwtiHdH3uxd-WfQRf9' },
      { name: 'modul04_07_ragas_degerlendirme.ipynb', desc: 'RAGAS ile faithfulness, answer relevance, context precision metrikleri', url: 'https://colab.research.google.com/drive/12fiWqgE_j9SLYshq7R557Zv9j3n1fEgA' },
      { name: 'modul04_08_production_patterns.ipynb', desc: 'Async streaming, structured output (Pydantic) ve response caching pratiği', url: 'https://colab.research.google.com/drive/1rKJoBXT1voDeYkOprLwEIl1VJDKKOtK4' },
    ],
    ...
    pptxDriveId: '1frT1XlB02UzssReroP-4p35lZDMW4ZTW',
  },
  {
    id: 5,
    slug: '05',
    ...
    notebooks: [
      { name: 'modul05_01_dataset_hazirlama.ipynb', desc: 'Türkçe instruction veri setini chat template ile Datasets formatına dönüştürme', url: 'https://colab.research.google.com/drive/1JQ4lgt3Z5QsX42t6DA-vTOUW-xdFI5OP' },
      { name: 'modul05_02_unsloth_qlora.ipynb', desc: 'Google Colab T4 üzerinde Unsloth ile 7B model QLoRA fine-tuning', url: 'https://colab.research.google.com/drive/1sf8OCWqN4dyokBGifeFVcJh0USrtzXjt' },
      { name: 'modul05_03_axolotl_yaml.ipynb', desc: 'Axolotl ile YAML config-driven fine-tuning workflow', url: 'https://colab.research.google.com/drive/1hs07zYc2h4ZsAQPBoEXLz7Sg9-vSHmOV' },
      { name: 'modul05_04_adapter_merge_gguf.ipynb', desc: 'LoRA adapter\'ı base model\'e merge etme ve GGUF formatına dönüştürme', url: 'https://colab.research.google.com/drive/1iM-ba_jEJ3IcMiBk_JONbrDvsoUPbyRp' },
      { name: 'modul05_05_hf_publish.ipynb', desc: 'Eğitilen modeli Hugging Face Hub\'a publish etme, model card yazma', url: 'https://colab.research.google.com/drive/1hawnnx7UJau8e8lKuZrvUdX2_lz7xc4b' },
    ],
    ...
    pptxDriveId: '1QMzVDRdSHyibAMwp22vtYiQPqUXsSoO1',
  },
  {
    id: 6,
    slug: '06',
    ...
    notebooks: [
      { name: 'modul06_01_ai_studio_management.ipynb', desc: 'Google AI Studio\'da prompt management, A/B comparison ve dataset yönetimi', url: 'https://colab.research.google.com/drive/1GO69b7d2Bqe7OxgxUm27pKkEXL0POOtN' },
      { name: 'modul06_02_antigravity_workflow.ipynb', desc: 'Antigravity IDE ile agent geliştirme ve plan-execute workflow\'u', url: 'https://colab.research.google.com/drive/1DhAzGlzbrplc_l-IxZ23qFSoV4JY6YOM' },
      { name: 'modul06_03_prompt_injection_defense.ipynb', desc: 'Prompt injection saldırı senaryoları ve savunma katmanları', url: 'https://colab.research.google.com/drive/1tR-toLNWb0lv3mHIhL8T5hikypAJELM1' },
      { name: 'modul06_04_guardrails_pii.ipynb', desc: 'Output validation, PII filtering ve guardrails ile güvenli LLM yanıtları', url: 'https://colab.research.google.com/drive/15X3Wc1T1cJdDJ6NzcHhN5R_2r9zYw25-' },
      { name: 'modul06_05_capstone_template.ipynb', desc: 'Capstone proje şablonu: RAG + fine-tuned model + Docker deploy', url: 'https://colab.research.google.com/drive/1EpGqfZaf668EwZQNW02SkfqOHNo9HlSm' },
    ],
    ...
    pptxDriveId: '18E8a6V7Z8deHY8OzzXCKy6whSL8mEq2j',
  },
];
